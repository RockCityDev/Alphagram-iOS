...
typedef SWIFT_ENUM(NSInteger, EVMTransactionType, open) {
...
typedef SWIFT_ENUM(NSInteger, GasFeeLevel, open) {
  GasFeeLevelLow = 0,
  GasFeeLevelMedium = 1,
  GasFeeLevelHigh = 2,
};
...
typedef SWIFT_ENUM(NSInteger, SolanaTransactionType, open) {
