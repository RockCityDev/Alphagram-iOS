...
typedef SWIFT_ENUM(NSInteger, GasLevel, closed) {
  GasLevelNone = 0,
  GasLevelCustom = 1,
  GasLevelLow = 2,
  GasLevelMedium = 3,
...
typedef SWIFT_ENUM(NSInteger, KccNetwork, closed) {
  KccNetworkMainnet = 0,
  KccNetworkTestnet = 1,
};

typedef SWIFT_ENUM(NSInteger, OptimismNetwork, closed) {
  OptimismNetworkMainnet = 0,
  OptimismNetworkGoerli = 1,
};

typedef SWIFT_ENUM(NSInteger, PlatONNetwork, closed) {
