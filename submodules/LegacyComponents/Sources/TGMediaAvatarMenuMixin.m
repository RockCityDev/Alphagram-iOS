...
@implementation TGMediaAvatarNFTMenu
...
- (instancetype)initWithContext:(id<LegacyComponentsContext>)context parentController:(TGViewController *)parentController hasSearchButton:(bool)hasSearchButton hasDeleteButton:(bool)hasDeleteButton hasViewButton:(bool)hasViewButton personalPhoto:(bool)personalPhoto isVideo:(bool)isVideo saveEditedPhotos:(bool)saveEditedPhotos saveCapturedMedia:(bool)saveCapturedMedia signup:(bool)signup {
    return [self initWithContext:context parentController:parentController hasSearchButton:hasSearchButton hasDeleteButton:hasDeleteButton hasViewButton:hasViewButton personalPhoto:personalPhoto isVideo:isVideo saveEditedPhotos:saveEditedPhotos saveCapturedMedia:saveCapturedMedia signup:signup nftMenu:nil];
}

- (instancetype)initWithContext:(id<LegacyComponentsContext>)context parentController:(TGViewController *)parentController hasSearchButton:(bool)hasSearchButton hasDeleteButton:(bool)hasDeleteButton hasViewButton:(bool)hasViewButton personalPhoto:(bool)personalPhoto isVideo:(bool)isVideo saveEditedPhotos:(bool)saveEditedPhotos saveCapturedMedia:(bool)saveCapturedMedia signup:(bool)signup nftMenu:(TGMediaAvatarNFTMenu *)nftMenu
{
    self = [super init];
    if (self != nil)
    {
...
- (TGMenuSheetController *)_presentAvatarMenu
{
    ...
    if (_nftMenu)
    {
        TGMenuSheetButtonItemView *viewItem = [[TGMenuSheetButtonItemView alloc] initWithTitle:_nftMenu.title type:TGMenuSheetButtonTypeDefault fontSize:20.0 icon:[[UIImage alloc] initWithBundleImageName:@"Settings/wallet/icon_new_marker"] action:^
        {
            __strong TGMediaAvatarMenuMixin *strongSelf = weakSelf;
            if (strongSelf == nil)
                return;
            ...
            [strongController dismissAnimated:true];
            if (strongSelf.didChooseNFTMenue) {
                strongSelf.didChooseNFTMenue();
            }
        }];
