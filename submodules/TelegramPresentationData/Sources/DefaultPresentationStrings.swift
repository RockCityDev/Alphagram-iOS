...
//        return PresentationStrings(primaryComponent: PresentationStrings.Component(languageCode: "en", localizedName: "English", pluralizationRulesCode: nil, dict: NSDictionary(contentsOf: URL(fileURLWithPath: getAppBundle().path(forResource: "Localizable", ofType: "strings", inDirectory: nil, forLocalization: "en")!)) as! [String : String]), secondaryComponent: nil, groupingSeparator: "")




var  staticDefaultPresentationStrings : PresentationStrings?  = nil
public var defaultPresentationStrings:(PresentationStrings) {
    get{
        
            if staticDefaultPresentationStrings != nil {
                return staticDefaultPresentationStrings!
            }
         
            var forLocalization = "en"
        
            if TBLanguage.sharedInstance.languageCode == "zhcncc"{
                forLocalization = "zh-Hans"
            }else if TBLanguage.sharedInstance.languageCode == "hongkong"
                        || TBLanguage.sharedInstance.languageCode == "taiwan" {
                forLocalization = "zh-HK"
            }
        
        
            staticDefaultPresentationStrings = PresentationStrings(primaryComponent: PresentationStrings.Component(languageCode: "en", localizedName: "English", pluralizationRulesCode: nil, dict: NSDictionary(contentsOf: URL(fileURLWithPath: getAppBundle().path(forResource: "Localizable", ofType: "strings", inDirectory: nil, forLocalization: forLocalization)!)) as! [String : String]), secondaryComponent: nil, groupingSeparator: "")
            return staticDefaultPresentationStrings!
        }
}
