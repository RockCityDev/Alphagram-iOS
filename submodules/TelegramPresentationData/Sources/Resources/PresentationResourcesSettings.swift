...
public struct PresentationResourcesSettings {
    ...
    public static let tb_privacy = renderIcon(name: "Settings/Menu/tb_privacy")
    public static let tb_tool = renderIcon(name: "Settings/Menu/tb_tools")
    
    public static let tb_my_wallet = renderIcon(name: "Settings/wallet/icon_my_crypto_wallet_settings")
    public static let tb_matamask_icon = renderIcon(name: "Settings/wallet/icon_matamask_settings")
    public static let tb_edit_profile = renderIcon(name: "Settings/wallet/icon_edit_nft_photot_settings")
    public static let tb_icon_eth_nft_edit = UIImage(bundleImageName: "Settings/wallet/icon_eth_nft_edit")
    public static let tb_icon_connected_wallet_settings = UIImage(bundleImageName: "Settings/wallet/icon_connected_wallet_settings")
