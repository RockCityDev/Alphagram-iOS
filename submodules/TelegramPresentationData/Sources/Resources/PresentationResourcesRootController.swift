...
public struct PresentationResourcesRootController {
    ...
    public static func navigationComposeIcon(_ theme: PresentationTheme, customColor: UIColor?) -> UIImage? {
        return theme.image(PresentationResourceKey.navigationComposeIcon.rawValue, { theme in
            return generateTintedImage(image: UIImage(bundleImageName: "Chat List/ComposeIcon"), color: customColor ?? theme.rootController.navigationBar.accentTextColor)
        })
    }
    ...
    public static func navigationAddIcon(_ theme: PresentationTheme, customColor: UIColor? = nil) -> UIImage? {
        return theme.image(PresentationResourceKey.navigationAddIcon.rawValue, { theme in
            return generateTintedImage(image: UIImage(bundleImageName: "Chat List/AddIcon"), color: customColor ?? theme.rootController.navigationBar.accentTextColor)
        })
    }
