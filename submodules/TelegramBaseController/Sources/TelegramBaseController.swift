...
open class TelegramBaseController: ViewController, KeyShortcutResponder {
    ...
    public init(context: AccountContext, navigationBarPresentationData: NavigationBarPresentationData?, mediaAccessoryPanelVisibility: MediaAccessoryPanelVisibility, locationBroadcastPanelSource: LocationBroadcastPanelSource, groupCallPanelSource: GroupCallPanelSource, customButtonColor: UIColor? = nil) {
        ...
        super.init(navigationBarPresentationData: navigationBarPresentationData, customButtonColor: customButtonColor)
