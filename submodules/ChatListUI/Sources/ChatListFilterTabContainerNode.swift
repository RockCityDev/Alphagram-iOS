...
private final class ItemNode: ASDisplayNode {
    ...
    func updateText(strings: PresentationStrings, title: String, shortTitle: String, unreadCount: Int, unreadHasUnmuted: Bool, isNoFilter: Bool, selectionFraction: CGFloat, isEditing: Bool, isReordering: Bool, canReorderAllChats: Bool, isDisabled: Bool, presentationData: PresentationData, transition: ContainedViewLayoutTransition) {
        ...
        if self.theme !== presentationData.theme {
            ...
            self.badgeBackgroundActiveNode.image = generateStretchableFilledCircleImage(diameter: 18.0, color: UIColor(hexString: "#FFE2F0FD")!)
            self.badgeBackgroundInactiveNode.image = generateStretchableFilledCircleImage(diameter: 18.0, color: UIColor(hexString: "#FFE2F0FD")!)
        }
        ...
        self.titleNode.attributedText = NSAttributedString(string: title, font: Font.medium(14.0), textColor: UIColor.white)
        self.titleActiveNode.attributedText = NSAttributedString(string: title, font: Font.medium(14.0), textColor: UIColor.white)
        self.shortTitleNode.attributedText = NSAttributedString(string: shortTitle, font: Font.medium(14.0), textColor: UIColor.white)
        ...
        if unreadCount != 0 {
            self.badgeTextNode.attributedText = NSAttributedString(string: "\(unreadCount)", font: Font.regular(14.0), textColor: UIColor(hexString: "#FF4B5BFF")!)
