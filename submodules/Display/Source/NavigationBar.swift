...
open class NavigationBar: ASDisplayNode {
    ...
    public func updateBarBackgroundColor(_ color: UIColor) {
        self.buttonsContainerNode.backgroundColor = color
    }
    ...
    private var title: String? {
        didSet {
            if let title = self.title {
                self.titleNode.attributedText = NSAttributedString(string: title, font: NavigationBar.titleFont, textColor: self.customButtonColor ?? self.presentationData.theme.primaryTextColor)
    ...
    private var customButtonColor: UIColor?
    
    public init(presentationData: NavigationBarPresentationData, customButtonColor: UIColor? = nil) {
...
//        self.buttonsContainerNode.backgroundColor = UIColor(hexString: "#FF4B5BFF")
        self.buttonsContainerNode.clipsToBounds = true
        
        self.backButtonNode.color = customButtonColor ?? self.presentationData.theme.buttonColor
        self.backButtonNode.disabledColor = self.presentationData.theme.disabledButtonColor
        self.leftButtonNode.color = customButtonColor ?? self.presentationData.theme.buttonColor
        self.leftButtonNode.disabledColor = self.presentationData.theme.disabledButtonColor
        self.rightButtonNode.color = customButtonColor ?? self.presentationData.theme.buttonColor
        ...
        self.backButtonArrow.image = NavigationBar.backArrowImage(color: customButtonColor ?? self.presentationData.theme.buttonColor)
        if let title = self.title {
            self.titleNode.attributedText = NSAttributedString(string: title, font: NavigationBar.titleFont, textColor: customButtonColor ?? self.presentationData.theme.primaryTextColor)
            self.titleNode.accessibilityLabel = title
        }
    ...
    public func updatePresentationData(_ presentationData: NavigationBarPresentationData) {
        if presentationData.theme !== self.presentationData.theme || presentationData.strings !== self.presentationData.strings {
            ...
            self.backButtonNode.color = self.customButtonColor ?? self.presentationData.theme.buttonColor
            self.backButtonNode.disabledColor = self.presentationData.theme.disabledButtonColor
            self.leftButtonNode.color = self.customButtonColor ?? self.presentationData.theme.buttonColor
            self.leftButtonNode.disabledColor = self.presentationData.theme.disabledButtonColor
            self.rightButtonNode.color = self.customButtonColor ?? self.presentationData.theme.buttonColor
            self.rightButtonNode.disabledColor = self.presentationData.theme.disabledButtonColor
            self.rightButtonNode.rippleColor = self.presentationData.theme.primaryTextColor.withAlphaComponent(0.05)
            self.backButtonArrow.image = NavigationBar.backArrowImage(color: self.customButtonColor ?? self.presentationData.theme.buttonColor)
            if let title = self.title {
                self.titleNode.attributedText = NSAttributedString(string: title, font: NavigationBar.titleFont, textColor: self.customButtonColor ?? self.presentationData.theme.primaryTextColor)
                self.titleNode.accessibilityLabel = title
            }
