...
@objc open class ViewController: UIViewController, ContainableController {
    ...
    public init(navigationBarPresentationData: NavigationBarPresentationData?, customButtonColor: UIColor? = nil) {
        self.statusBar = StatusBar()
        if let navigationBarPresentationData = navigationBarPresentationData {
            self.navigationBar = NavigationBar(presentationData: navigationBarPresentationData, customButtonColor: customButtonColor)
        } else {
