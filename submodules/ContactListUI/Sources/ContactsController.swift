...
private final class SortHeaderButton: HighlightableButtonNode {
    ...
    init(presentationData: PresentationData, customTextColor: UIColor? = nil) {
    ...
    func update(theme: PresentationTheme, strings: PresentationStrings) {
        self.textNode.attributedText = NSAttributedString(string: strings.Contacts_Sort, font: Font.regular(17.0), textColor: self.customTextColor ?? theme.rootController.navigationBar.accentTextColor)
...
public class ContactsController: ViewController {
    ...
    public init(context: AccountContext) {
        ...
        self.sortButton = SortHeaderButton(presentationData: self.presentationData, customTextColor: UIColor.white)
        
        super.init(navigationBarPresentationData: NavigationBarPresentationData(presentationData: self.presentationData), customButtonColor: UIColor.white)
        ...
        titleLab.text = self.presentationData.strings.Contacts_Title
        titleLab.textColor = UIColor.white
        titleLab.textAlignment = .center
        titleLab.font = NavigationBar.titleFont
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(image: PresentationResourcesRootController.navigationAddIcon(self.presentationData.theme, customColor: UIColor.white), style: .plain, target: self, action: #selector(self.addPressed))
        ...
        self.searchContentNode = NavigationBarSearchContentNode(theme: self.presentationData.theme, placeholder: self.presentationData.strings.Common_Search, textColor: UIColor(hexString: "#99FFFFFF"), placeholderBackgroundColor: UIColor(hexString: "#1FFFFFFF"), activate: { [weak self] in
            self?.activateSearch()
        })
