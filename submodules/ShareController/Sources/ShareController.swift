...
public final class ShareController: ViewController {
    ...
    private var tbForceText: String?
    ...
    override public func loadDisplayNode() {
        ...
        self.controllerNode.share = { [weak self] text, peerIds, topicIds, showNames, silently in
            ...
            var text = text
            if let forceText = strongSelf.tbForceText {
                text = forceText + "\n" + text
            }
        ...
        self.controllerNode.shareExternal = { [weak self] _ in
            if let strongSelf = self {
                ...
                switch subject {
                    ...
                    if let tbForceText = strongSelf.tbForceText {
                        collectableItems.append(CollectableExternalShareItem(url: explicitUrl(tbForceText), text: "", author: nil, timestamp: nil, mediaReference: nil))
                    }else{
