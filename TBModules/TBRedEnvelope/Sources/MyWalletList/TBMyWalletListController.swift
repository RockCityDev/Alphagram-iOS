...
public final class TBMyWalletListController: ViewController {
    ...
    public init(context: AccountContext, updatedPresentationData: (initial: PresentationData, signal: Signal<PresentationData, NoError>)? = nil, params:Params) {
    ...
    override public func loadDisplayNode() {
        ...
        let node = Node(context: self.context, presentationData: self.presentationData, controller: self, params: self.params)
    ...
    class Node: ViewControllerTracingNode, UIScrollViewDelegate {
        private weak var controller: TBMyWalletListController?
        private let context: AccountContext
        private var presentationData: PresentationData
        private let params:Params
        ...
        init(context: AccountContext, presentationData: PresentationData, controller: TBMyWalletListController, params: Params) {
            ...
            self.contentContainerNode.onDidLoad {[weak self] node in
                ...
                let contentView = TBMyWalletListView(context: strongSelf.context, params: strongSelf.params)
        ...
        func containerLayoutUpdated(_ layout: ContainerViewLayout, navigationBarHeight: CGFloat, transition: ContainedViewLayoutTransition) {
            ...
            if let contentView = self.contentView {
                transition.updateFrame(view: contentView, frame: CGRect(origin: .zero, size: contentContainerFrame.size))
            }
