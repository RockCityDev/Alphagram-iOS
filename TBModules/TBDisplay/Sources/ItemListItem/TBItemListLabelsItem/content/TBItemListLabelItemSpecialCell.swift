...
public class TBItemListLabelItemSpecialCell: UICollectionViewCell {
    ...
    public override init(frame: CGRect) {
        ...
        self.deleteIcon = UIImageView(image: UIImage(bundleImageName: "Settings/wallet/tb_ic_check"))
    ...
    public func reloadCell(item: TBWeb3GroupInfoEntry.Tag, config: TBItemListLabelsContentLayoutConfig) {
        ...
        if item.selected {
            self.deleteIcon.image = UIImage(bundleImageName: "Settings/wallet/tb_ic_check")
            self.contentLabel.textColor = .white
            self.contentView.layer.borderColor = UIColor(rgb: 0x4B5BFF).cgColor
            self.contentView.backgroundColor = UIColor(rgb: 0x4B5BFF)
        }else{
            self.deleteIcon.image = UIImage(bundleImageName: "Settings/wallet/tb_ic_add")
            self.contentLabel.textColor = UIColor(rgb: 0x56565C)
            self.contentView.layer.borderColor = UIColor(rgb: 0xDCDDE0).cgColor
