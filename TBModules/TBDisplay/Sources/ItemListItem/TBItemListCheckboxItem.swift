...
public enum TBItemListCheckboxItemStyle {
    case left
    case right
}

public enum TBItemListCheckboxItemColor {
    case accent
    case secondary
}

public class TBItemListCheckboxItem: ListViewItem, ItemListItem {
    ...
    let title: String
    let subtitle: String?
    let style: TBItemListCheckboxItemStyle
    let color: TBItemListCheckboxItemColor
    ...
    public init(presentationData: ItemListPresentationData, icon: TBSDImage? = nil, iconSize: CGSize? = nil, iconPlacement: IconPlacement = .default, title: String, subtitle: String? = nil, style: TBItemListCheckboxItemStyle, color: TBItemListCheckboxItemColor = .accent, textColor: TextColor = .primary, checked: Bool, zeroSeparatorInsets: Bool, sectionId: ItemListSectionId, action: @escaping () -> Void, deleteAction: (() -> Void)? = nil) {
    ...
    public func nodeConfiguredForParams(async: @escaping (@escaping () -> Void) -> Void, params: ListViewItemLayoutParams, synchronousLoads: Bool, previousItem: ListViewItem?, nextItem: ListViewItem?, completion: @escaping (ListViewItemNode, @escaping () -> (Signal<Void, NoError>?, (ListViewItemApply) -> Void)) -> Void) {
        async {
            let node = TBItemListCheckboxItemNode()
    ...
    public func updateNode(async: @escaping (@escaping () -> Void) -> Void, node: @escaping () -> ListViewItemNode, params: ListViewItemLayoutParams, previousItem: ListViewItem?, nextItem: ListViewItem?, animation: ListViewItemUpdateAnimation, completion: @escaping (ListViewItemNodeLayout, @escaping (ListViewItemApply) -> Void) -> Void) {
        Queue.mainQueue().async {
            if let nodeValue = node() as? TBItemListCheckboxItemNode {
...
public class TBItemListCheckboxItemNode: ItemListRevealOptionsItemNode {
    ...
    private let imageNode: TBSDImageNode
    private let iconNode: ASImageNode
    private let titleNode: TextNode
    private let subtitleNode: TextNode
    
    private var item: TBItemListCheckboxItem?
    ...
    public func asyncLayout() -> (_ item: TBItemListCheckboxItem, _ params: ListViewItemLayoutParams, _ neighbors: ItemListNeighbors) -> (ListViewItemNodeLayout, () -> Void) {
        ...
        return { item, params, neighbors in
            ...
            return (layout, { [weak self] in
                if let strongSelf = self {
                    ...
                    strongSelf.imageNode.image = item.icon
