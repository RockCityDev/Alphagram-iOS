...
public class TBVipGroupOrderViewController: ViewController {
    ...
    private let implController: TBVipGroupOrderInfoImplController
    ...
    public init(context: AccountContext,
        ...
        self.implController = TBVipGroupOrderInfoImplController(
