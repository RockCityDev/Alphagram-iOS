...
public class TBVerifyGroupInfoController: ViewController {
    ...
    private let implController: TBVerifyGroupInfoControllerImp
    ...
    public init(context: AccountContext,
        ...
        self.implController = TBVerifyGroupInfoControllerImp(
    ...
    public override func displayNodeDidLoad() {
        ...
        self.implController.verifySuccessHandle = {[weak self] url in
            self?.verifySuccessHandle?(url)
        }
    }
